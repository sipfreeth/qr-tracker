// api/points.js
//
// URL: https://your-project.vercel.app/api/points
// ใช้สำหรับ "เช็คแต้มของฉัน" — ไม่เกี่ยวกับการสแกน QR
// พาไปล็อกอิน LINE แล้ว callback.js จะรู้ว่าต้องแสดงหน้าแต้ม ไม่ใช่ redirect ไปโปรโมชั่น

export default async function handler(req, res) {
  const state = Buffer.from(
    JSON.stringify({ action: 'view_points' })
  ).toString('base64url');
